...
use bevy::prelude::{default, BackgroundColor, BorderColor, Color, Commands, Component, CursorIcon, Entity, GlobalTransform, Has, Image, ImageBundle, Local, Mut, Name, NextState, NodeBundle, PositionType, Query, Res, ResMut, Resource, States, Style, Text, TextBundle, TextStyle, TextureAtlas, TextureAtlasLayout, UiImage, UiRect, Val, Vec3Swizzles, World, ZIndex};
use bevy_asset_loader::asset_collection::AssetCollection;
use bevy_mod_picking::prelude::*;
use haalka::prelude::*;
use haalka::raw::DeferredUpdaterAppendDirection;
use rand::Rng;
...
fn bern_cell_data_option(bern: f64) -> Mutable<Option<CellData>> {
    Mutable::new('block: {
        let mut distribution = Bernoulli::new(bern).unwrap();

use crate::civilization::components::conflict_components::{UnresolvedCityConflict, UnresolvedConflict};
...
use bevy::core::Name;
use bevy::prelude::{Commands, Entity, Has, NextState, Query, ResMut};

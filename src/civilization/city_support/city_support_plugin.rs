...
use crate::civilization::city_support::city_support_systems;
...
impl Plugin for CitySupportPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(OnEnter(GameActivity::CheckCitySupport), city_support_systems::check_city_support)
            .add_systems(Update,
                         (
                             ...
                             city_support_systems::check_city_support.run_if(in_state(GameActivity::CheckCitySupport)),

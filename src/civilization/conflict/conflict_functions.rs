use crate::civilization::general::general_functions::{remove_n_tokens_from_each_player, return_all_but_n_tokens_to_stock_for_player, return_all_tokens_from_area_for_player, return_all_tokens_to_stock};
use crate::civilization::general::general_triggers::ReturnTokenToStock;
